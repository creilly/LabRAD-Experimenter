...
class FunctionEditor( Editor ):
    def __init__( self, title, parent ):
        ...
        labradConnection.connectionLost.connect( lambda: labradButton.setEnabled( False ) )
        labradConnection.connectionMade.connect( lambda: labradButton.setEnabled( True ) )
